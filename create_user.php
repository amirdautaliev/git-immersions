        ...
        <div class="subheader">
            <h1 class="subheader-title">
                <i class='subheader-icon fal fa-plus-circle'></i> Добавить пользователя
                 ...
                 <?php if (isset($_SESSION['dange'])): ?>
                                    <div class="alert alert-danger text-dark" role="alert">
                                       <?php  echo $_SESSION["dange"];
                                              unset($_SESSION['dange']);
                                         ?>
                                    </div>
                                    <?php endif;?>
                                    <?php if (isset($_SESSION['sucss'])): ?>
                                    <div class="alert alert-success text-dark" role="alert">
                                       <?php  echo $_SESSION["sucss"];
                                              unset($_SESSION['sucss']);
                                         ?>
                                    </div>
                                    <?php endif;?>
                            ...
                            <div class="panel-content">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="example-select" name="status" >
                                        <?php foreach ($data as $sid =>$status_name ){
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="file" id="example-fileinput" class="form-control-file" name="images">
                                </div>
                            </div>
                        </div>
