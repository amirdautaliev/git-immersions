                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <input type="hidden" name="id" value="<?=$status_id?>"> 
                                            ...
                                            <select class="form-control" id="example-select" name = "status">
																...
																<?php
																foreach ($data as $id =>$status_value)
																{
																	if($status == $id){
																
																		echo '<option value="' . $id . '"  selected>' . $status_value. '</option>';
																		
																
																	}
													else{
														echo '<option value="' . $id . '" >' . $status_value. '</option>';
													}
																}
															// 		if($id === $status)
															// 		{
															// 			echo "<option selected='selected' value='".$id."'>".$status_value."</option>";
															// 		}
