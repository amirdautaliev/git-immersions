        ...
        <main id="js-page-content" role="main" class="page-content mt-3">
            ...
            <?php foreach($people as $person):?>
                <div class="col-xl-4">
                    ...
                    <div id="c_1" class="card border shadow-0 mb-g shadow-sm-hover" data-filter-tags="<?php echo $person["tags"]; ?>">
                            ...
                            <div class="d-flex flex-row align-items-center">
                                ...
                                <div class="info-card-text flex-1">
                                    ...
                                    <div class="dropdown-menu">
                                        ...
                                        <a class="dropdown-item" href="page_profile.php?id=<?= $person["id"];?>">
                                        ...
                                        <a href="delete_image.php?id=<?= $person['id'];?>" class="dropdown-item" onclick="return confirm('are you sure?');">
                                            <i class="fa fa-window-close"></i>
                                            Удалить аватар
                                        </a>
                                        <a href="delete.php?id=<?= $person['id'];?>" class="dropdown-item" onclick="return confirm('are you sure?');">
                                            <i class="fa fa-window-close"></i>
                                            Удалить
                                        </a>
