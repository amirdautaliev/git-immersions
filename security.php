...
is_logged_in();
$logged_user_id= $_SESSION['id']; // текущий пользователь
$edit_user_id= $_GET['id'];  // текущий запись
							...
							<div class="alert alert-danger text-dark" role="alert">
                                ...
                                <?php if (isset($_SESSION["secruity_sucsess"])):?>
                                    <div class="alert alert-sucsess text-dark" role="alert">
                                        ...
                                        ?>
                                        <?php endif;?>
        <form action="secruity_handler.php" method="POST">
            <div class="row">
                        ...
                        <div class="panel-container">
                            ...
                            <div class="panel-content">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text"  name ="email" id="simpleinput" class="form-control" value="<?= $user_info['email'];?>">
